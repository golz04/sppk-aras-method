    ...
    <div class="flex flex-wrap -mx-3">
        <div class="flex-none w-full max-w-full px-3">
            <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{url('laptop/import')}}">
                    @csrf
                ...
                <div class="p-6 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                    <h6>Tambah Data Laptop</h6>
                </div>
                <hr class="h-px mt-0 bg-transparent bg-gradient-horizontal-dark">
                <form action="{{url('laptop/store')}}" method="POST">
                    @csrf
                    <div class="flex-auto px-0 pt-0 pb-2">
                        <div class="p-0 overflow-x-auto">
                            <div class="mx-6 mb-4">
                                <label class="text-gray-700 ml-1" for="company">Perusahaan : </label>
                                <input type="text" name="company" class="form-input w-full block rounded mt-1 p-2 border-2 @error('company') border-red-500 @enderror focus:outline-none border-pink-500" placeholder="Perusahaan" value="{{old('company')}}">
                                @error('company')
                                <span class="pl-1 text-xs text-red-600 text-bold">
                                    {{$message}}
                                </span>
                        ...
                        <div class="p-0 overflow-x-auto">
                            <div class="mx-6 mb-4">
                                <label class="text-gray-700 ml-1" for="product">Produk : </label>
                                <input type="text" name="product" class="form-input w-full block rounded mt-1 p-2 border-2 @error('product') border-red-500 @enderror focus:outline-none border-pink-500" placeholder="Produk" value="{{old('product')}}">
                                @error('product')
                                <span class="pl-1 text-xs text-red-600 text-bold">
                                    {{$message}}
                                </span>
                        ...
                        <div class="p-0 overflow-x-auto">
                            <div class="mx-6 mb-4">
                                <label class="text-gray-700 ml-1" for="type_name">Nama Tipe : </label>
                                <input type="text" name="type_name" class="form-input w-full block rounded mt-1 p-2 border-2 @error('type_name') border-red-500 @enderror focus:outline-none border-pink-500" placeholder="Nama Tipe" value="{{old('type_name')}}">
                                @error('type_name')
                                <span class="pl-1 text-xs text-red-600 text-bold">
                                    {{$message}}
                                </span>
                        ...
                        <div class="p-0 overflow-x-auto">
                            <div class="mx-6 mb-4">
                                <label class="text-gray-700 ml-1" for="screen_resolution">Resolusi Layar : </label>
                                <input type="text" name="screen_resolution" class="form-input w-full block rounded mt-1 p-2 border-2 @error('screen_resolution') border-red-500 @enderror focus:outline-none border-pink-500" placeholder="Resolusi Layar" value="{{old('screen_resolution')}}">
                        ...
                        <div class="p-0 overflow-x-auto">
                            <div class="mx-6 mb-4">
                                <label class="text-gray-700 ml-1" for="cpu">CPU : </label>
                                <input type="text" name="cpu" class="form-input w-full block rounded mt-1 p-2 border-2 @error('cpu') border-red-500 @enderror focus:outline-none border-pink-500" placeholder="CPU" value="{{old('cpu')}}">
                                @error('cpu')
                                <span class="pl-1 text-xs text-red-600 text-bold">
                                    {{$message}}
                                </span>
                        ...
                        <div class="p-0 overflow-x-auto">
                            <div class="mx-6 mb-4">
                                <label class="text-gray-700 ml-1" for="memory">Memory : </label>
                                <input type="text" name="memory" class="form-input w-full block rounded mt-1 p-2 border-2 @error('memory') border-red-500 @enderror focus:outline-none border-pink-500" placeholder="Memory" value="{{old('memory')}}">
                                @error('memory')
                                <span class="pl-1 text-xs text-red-600 text-bold">
                                    {{$message}}
                                </span>
                        ...
                        <div class="p-0 overflow-x-auto">
                            <div class="mx-6 mb-4">
                                <label class="text-gray-700 ml-1" for="gpu">GPU : </label>
                                <input type="text" name="gpu" class="form-input w-full block rounded mt-1 p-2 border-2 @error('gpu') border-red-500 @enderror focus:outline-none border-pink-500" placeholder="GPU" value="{{old('gpu')}}">
                                @error('gpu')
                                <span class="pl-1 text-xs text-red-600 text-bold">
                                    {{$message}}
                                </span>
                        ...
                        <div class="p-0 overflow-x-auto">
                            <div class="mx-6 mb-4">
                                <label class="text-gray-700 ml-1" for="operating_system">Sistem Operasi : </label>
                                <input type="text" name="operating_system" class="form-input w-full block rounded mt-1 p-2 border-2 @error('operating_system') border-red-500 @enderror focus:outline-none border-pink-500" placeholder="Sistem Operasi" value="{{old('operating_system')}}">
                        ...
                        <div class="p-0 overflow-x-auto">
                            <div class="mx-6 mb-4">
                                <label class="text-gray-700 ml-1" for="weight">Weight : </label>
                                <input type="text" name="weight" class="form-input w-full block rounded mt-1 p-2 border-2 @error('weight') border-red-500 @enderror focus:outline-none border-pink-500" placeholder="Weight" value="{{old('weight')}}">
                                @error('weight')
                                <span class="pl-1 text-xs text-red-600 text-bold">
                                    {{$message}}
                                </span>
                        ...
                        <div class="p-0 overflow-x-auto">
                            <div class="mx-6 mb-4">
                                <label class="text-gray-700 ml-1" for="price_euros">Harga : </label>
                                <input type="text" name="price_euros" class="form-input w-full block rounded mt-1 p-2 border-2 @error('price_euros') border-red-500 @enderror focus:outline-none border-pink-500" placeholder="Harga" value="{{old('price_euros')}}">
                                @error('price_euros')
                                <span class="pl-1 text-xs text-red-600 text-bold">
                                    {{$message}}
                                </span>
                        ...
                        <div class="p-0 overflow-x-auto">
                            <div class="mr-12 mb-4 text-right mt-4">
                                <input type="submit" value="Simpan" class="inline-block px-8 py-2 mb-0 font-bold text-center uppercase align-middle transition-all bg-transparent border border-solid rounded-lg shadow-none cursor-pointer leading-pro ease-soft-in text-size-xs hover:scale-102 active:shadow-soft-xs tracking-tight-soft border-fuchsia-500 text-fuchsia-500 hover:border-fuchsia-500 hover:bg-transparent hover:text-fuchsia-500 hover:opacity-75 hover:shadow-none active:bg-fuchsia-500 active:text-white active:hover:bg-transparent active:hover:text-fuchsia-500">
                            </div>
                        </div>
                    </div>
                </form>
